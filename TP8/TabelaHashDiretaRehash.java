...
class HashRehash {
    ...
    public boolean pesquisar(String name) {
        ...
        if (resp) {
            ...
            TabelaHashDiretaRehash.logWriter.println(name + ":  (Posicao: " + posFinal + ") SIM");
        } else {
            System.out.println(name + ":  (Posicao: " + posFinal + ") NAO");
            TabelaHashDiretaRehash.logWriter.println(name + ":  (Posicao: " + posFinal + ") NAO");
        }
        return resp;
    }
}
...
public class TabelaHashDiretaRehash {
    ...
    public static void main(String[] args) {
        ...
        // Arquivo log
        try {
            logWriter = new PrintWriter(new FileWriter("876881_hashRehash.txt"));
        } catch (IOException e) {
